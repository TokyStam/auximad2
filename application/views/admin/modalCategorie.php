    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal" enctype="multipart/form-data" method="POST" role="form">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea class=" form-control" type="text" placeholder="Entrer détail categorie service" name="detail_categorie_service"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Titre catégorie service</label>
                            <div class="col-md-9">
                                <input name="titre_categorie_service2" class="form-control" type="file">
                            </div>
                        </div>
                    </div>
                </form>
